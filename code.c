...
void end()
{
    ...
    getGreen(4);
    resetRelative();
    moveNoSyncMinspeedParam(100, 100, 420, 0.4, 0.25, false, RELDEG);
    setSpeed(0, 0);
...
void farCode()
{
    ...
    moveNoSyncAccParamWallSquare(20, 20, 20, 20, 470, false, RELDEG);
    resetRelative();
    setSpeed(0, 0);
    ...
    turn1MotorAccMinspeed(100, 100, 100, -20, 0.4, 0.4, false, RIGHT);
